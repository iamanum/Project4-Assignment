...
def display_first_element(lst):
    if lst:  # Check if the list is not empty
        print(f"The first element in your list is: {lst[0]}")
    else:
...
def main():
    ...
    # Call the function to display the first element
    display_first_element(num_list)
